...
function initScene() {
    ...
    for (var i in countryLookup) {
        if ($.inArray(countryLookup[i], selectableCountries) < 0)
            selectableCountries.push(countryLookup[i]);
    ...
    console.log('main kyear');
    console.log(kyear);
    selectVisualization(timeBins, kyear, ['宁波'], ['Military Weapons', 'Civilian Weapons', 'Ammunition'], ['Military Weapons', 'Civilian Weapons', 'Ammunition']);
...
var countryColorMap = {
    ...
    "CNNINGXIA": 46,
    "CNHAINAN": 116,
    "CNZHEJIANGZHOUSHAN": 80,
    "CNZHEJIANGHANGZHOU": 164,
    "CNZHEJIANGNINGBO": 82,
    "CNZHEJIANGLISHUI": 119,
    "CNZHEJIANGSHAOXING": 121,
    "CNZHEJIANGHUZHOU": 114,
    "CNZHEJIANGJINHUA": 153,
    "CNZHEJIANGQUZHOU": 104,
    "CNZHEJIANGTAIZHOU": 110,
    "CNZHEJIANGWENZHOU": 38,
    "CNZHEJIANGJIAXING": 83
};
