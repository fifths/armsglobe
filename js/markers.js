...
function attachMarkerToCountry( countryName, importance ){
    //console.log('importance111111111')
    //console.log(countryName);
    //console.log(importance);
	//	look up the name to mesh
	countryName = countryName.toUpperCase();
	var country = countryData[countryName];
    //console.log('country222222222');
	...
	if(country.exportedAmount > 0 && country.importedAmount > 0) {
	   importExportText += "本地游玩人数:&nbsp;" + country.importedAmount + "<br />"
               +"本地游玩订单:&nbsp;" + country.importedAmount1 + "<br />"
           + "出游人数:&nbsp;"+country.exportedAmount+ "<br />"
           + "出游订单:&nbsp;"+country.exportedAmount1;
	} else if(country.exportedAmount > 0 && country.importedAmount == 0) {
	   importExportText += "出游人数:&nbsp;"+country.exportedAmount+"<br />"
        +"出游订单:&nbsp;"+country.exportedAmount1+"<br />&nbsp;";
	} else if(country.exportedAmount == 0 && country.importedAmount > 0) {
	   importExportText += "本地游玩人数:&nbsp;"+country.importedAmount+"<br />"
       +"本地游玩订单:&nbsp;"+country.importedAmount1+"<br />&nbsp;";
	}
